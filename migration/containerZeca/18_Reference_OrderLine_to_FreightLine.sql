...
INSERT INTO AD_Ref_Table (AD_Key,IsValueDisplayed,AD_Client_ID,AD_Reference_ID,AD_Org_ID,AD_Table_ID,EntityType,IsActive,AD_Display,Created,CreatedBy,Updated,UpdatedBy) VALUES (1008396,'Y',0,9000279,0,54259,'U','Y',83750,TO_TIMESTAMP('2019-11-28 18:14:56','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-11-28 18:14:56','YYYY-MM-DD HH24:MI:SS'),100)
;

UPDATE AD_Column SET AD_Reference_Value_ID=9000279, AD_Reference_ID=18,Updated=TO_TIMESTAMP('2019-11-28 18:15:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=9008403
;

UPDATE AD_Ref_Table SET IsValueDisplayed='N',Updated=TO_TIMESTAMP('2019-11-28 18:17:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=9000279
;

UPDATE AD_Ref_Table SET AD_Window_ID=53519,Updated=TO_TIMESTAMP('2019-11-28 19:15:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=9000279
;
