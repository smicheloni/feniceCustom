...
-- Field "IsSOTrx" on window "Freight Order", AD_Field_ID= 9020589
INSERT INTO AD_Field (IsEncrypted,AD_Client_ID,AD_Org_ID,IsDisplayed,IsActive,DisplayLength,AD_Field_ID,AD_Column_ID,IsFieldOnly,Name,AD_Tab_ID,IsCentrallyMaintained,EntityType,Help,IsReadOnly,IsSameLine,IsHeading,Created,CreatedBy,Description,Updated,UpdatedBy) VALUES ('N',0,0,'Y','Y',1,9020589,9008402,'N','Sales Transaction',54312,'Y','EE03','The Sales Transaction checkbox indicates if this item is a Sales Transaction.','N','N','N',TO_TIMESTAMP('2019-11-28 14:43:08','YYYY-MM-DD HH24:MI:SS'),100,'This is a Sales Transaction',TO_TIMESTAMP('2019-11-28 14:43:08','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET SeqNo=40,IsDisplayed='Y' WHERE AD_Field_ID=9020589
;
...
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2019-11-28 14:43:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=9020589
;
