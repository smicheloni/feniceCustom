...
// I
	...
	public org.compiere.model.I_C_UOM getCalculated() throws RuntimeException
    {
		return (org.compiere.model.I_C_UOM)MTable.get(getCtx(), org.compiere.model.I_C_UOM.Table_Name)
			.getPO(getCalculatedUOM(), get_TrxName());	}

	/** Set Calculated UOM.
		@param CalculatedUOM 
		The UOM in which the weights are measured.
	  */
	public void setCalculatedUOM (int CalculatedUOM)
	{
		set_Value (COLUMNNAME_CalculatedUOM, Integer.valueOf(CalculatedUOM));
	}

	/** Get Calculated UOM.
		@return The UOM in which the weights are measured.
	  */
	public int getCalculatedUOM () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_CalculatedUOM);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Net Weight.
		@param NetWeight 
		Net weight is the weight of the goods without container.
	  */
	...
	/** Get Net Weight.
		@return Net weight is the weight of the goods without container.
	  */
	...
	/** Get Tare Weight.
		@return Tare weight is the weight of the empty container
	  */
